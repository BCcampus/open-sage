...
class Page extends Controller {
	...
	/**
	 * Returns the Second Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen2() {
		$id = get_theme_mod( 'what_is_open_2', '' );

		return intval( $id );
	}

	/**
	 * Returns the Third Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen3() {
		$id = get_theme_mod( 'what_is_open_3', '' );

		return intval( $id );
	}

	/**
	 * Returns the Fourth Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen4() {
		$id = get_theme_mod( 'what_is_open_4', '' );

		return intval( $id );
	}

	/**
	 * Returns the Fifth Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen5() {
		$id = get_theme_mod( 'what_is_open_5', '' );

		return intval( $id );
	}

	/**
	 * Returns the Sixth Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen6() {
		$id = get_theme_mod( 'what_is_open_6', '' );

		return intval( $id );
	}

	/**
	 * Returns the Seventh Cards Page ID that was set in the customizer menu for the "What is Open Education" page
	 *
	 * @return string
	 */
	public function getWhatIsOpen7() {
		$id = get_theme_mod( 'what_is_open_7', '' );
