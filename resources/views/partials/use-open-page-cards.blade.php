        ...
        <article class="homepage-cards-item col-md-6 mb-2" itemscope itemtype="http://schema.org/Article">
            ...
            <div class="row-fluid min-height-md">
                ...
                <div class="col text-center">
                    <a class="btn btn-primary mb-3" href="{{\App\Controllers\App::maybeGuid($get_use_open_left_card_id, get_post_field('post_name', $get_use_open_left_card_id))}}" role="button">Learn More</a>
                </div>
            </div>
