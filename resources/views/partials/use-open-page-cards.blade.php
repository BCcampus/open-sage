<section class="homepage-cards d-flex flex-row flex-wrap full-width">
        <article class="homepage-cards-item col-md-6 mb-2" itemscope itemtype="http://schema.org/Article">
            <a href="{{ get_permalink($get_use_open_left_card_id) }}" class="img-link">
                <div class="featured-cards row-fluid d-flex" style="background-image: url({{\App\Controllers\App::getThumbUrl($get_use_open_left_card_id)}});">
            ...
            <div class="row-fluid min-height-md">
                <p class="p-3">{{\App\Controllers\App::getPostExcerpt($get_use_open_left_card_id)}}</p>
                <div class="col text-center">
                    <a class="btn btn-primary mb-3" aria-label="Read more about {!!get_the_title($get_use_open_left_card_id)!!}" href="{{\App\Controllers\App::maybeGuid($get_use_open_left_card_id, get_post_field('post_name', $get_use_open_left_card_id))}}" role="button">Learn More</a>
                </div>
            </div>
    ...
    <article class="homepage-cards-item col-md-6 mb-2" itemscope itemtype="http://schema.org/Article">
        <a href="{{ get_permalink($get_use_open_right_card_id) }}" class="img-link">
            <div class="featured-cards row-fluid d-flex" style="background-image: url({{\App\Controllers\App::getThumbUrl($get_use_open_right_card_id)}});">
        ...
        <div class="row-fluid min-height-md">
            <p class="p-3">{{\App\Controllers\App::getPostExcerpt($get_use_open_right_card_id)}}</p>
            <div class="col text-center">
                <a class="btn btn-primary mb-3" aria-label="Read more about {!!get_the_title($get_use_open_right_card_id)!!}" href="{{\App\Controllers\App::maybeGuid($get_use_open_right_card_id, get_post_field('post_name', $get_use_open_right_card_id))}}" role="button">Learn More</a>
            </div>
        </div>
