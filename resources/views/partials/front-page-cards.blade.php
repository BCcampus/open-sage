<section class="homepage-cards d-flex flex-row flex-wrap full-width no-gutters">
        <article class="homepage-cards-item col-md-6" itemscope itemtype="http://schema.org/Article">
            ...
            <div class="row-fluid min-height-md">
                ...
                <div class="col text-center">
                    <a class="btn btn-primary mb-3" aria-label="Read more about {!!get_the_title($get_left_card_id)!!}" href="{{\App\Controllers\App::maybeGuid($get_left_card_id, get_post_field('post_name', $get_left_card_id))}}" role="button">Learn More</a>
                </div>
            </div>
    ...
    <article class="homepage-cards-item col-md-6 pl-2" itemscope itemtype="http://schema.org/Article">
        ...
        <div class="row-fluid min-height-md">
            ...
            <div class="col text-center">
                <a class="btn btn-primary mb-3" aria-label="Read more about {!!get_the_title($get_right_card_id)!!}" href="{{\App\Controllers\App::maybeGuid($get_right_card_id, get_post_field('post_name', $get_right_card_id))}}" role="button">Learn More</a>
            </div>
        </div>
