...
<div class="col-md-6 bkgd-blue-navy">
    <h2>{!! get_the_title($get_hero_create_oer) !!}</h2>
    <p class="py-3">{{\App\Controllers\App::getPostExcerpt($get_hero_create_oer)}}</p>
    <a class="btn btn-primary mb-3" href="{{\App\Controllers\App::maybeGuid($get_hero_create_oer, get_post_field('post_name', $get_hero_create_oer))}}" role="button">Learn More</a>
</div>
