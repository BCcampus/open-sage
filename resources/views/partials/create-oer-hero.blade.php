...
<div class="col-md-6 bkgd-blue-navy p-3">
    ...
    <a class="btn btn-primary mb-3" aria-label="Read more about {!! get_the_title($get_hero_create_oer) !!}" href="{{\App\Controllers\App::maybeGuid($get_hero_create_oer, get_post_field('post_name', $get_hero_create_oer))}}" role="button">View step-by-step process</a>
</div>
